...
General: Set the number of processors to use when launching an external mpi
    ...
    contains -n or -np. Otherwise it is ignored since the launching function
    determines the number of available processors on its own.

Arguments: Any integer number to set the number of processors to use
