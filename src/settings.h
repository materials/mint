...
enum SettingsLabel {NUMPROCS, OUTPUT_LEVEL, OUTPUT_TAB, TIME_SHOW, TIME_PRECISION, TIME_FORMAT, TOLERANCE, CLUSTERTOL,\
	...
	GAOPT_USEREITVELD, GAOPT_SCREENMETHOD, GAOPT_SCREENNUM, GAOPT_ALLOWRESTART, WYCKOFFBIAS, MINIMAGEDISTANCE, \
	MAXJUMPDISTANCE, KMC_JUMPSPERATOM, KMC_CONVERGENCE, XRD_BACKGROUNDCOUNT};
